    ...
    module_globals.update(
        {
            ...
            "_prepare_seed_repository_closure_unlocked": workflow._prepare_seed_repository_closure_unlocked,
            ...
            "_materialize_dependency_roots_unlocked": workflow._materialize_dependency_roots_unlocked,

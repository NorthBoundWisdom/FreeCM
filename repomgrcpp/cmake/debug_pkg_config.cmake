...
#
# Usage:
#   cmake -DFREECM_PKG_CONFIG_MODULES="gmp;mpfr" -P debug_pkg_config.cmake

if(NOT DEFINED FREECM_PKG_CONFIG_MODULES OR FREECM_PKG_CONFIG_MODULES STREQUAL "")
    message(FATAL_ERROR "Set FREECM_PKG_CONFIG_MODULES to a semicolon-separated module list")
endif()

find_package(PkgConfig REQUIRED)

foreach(module IN LISTS FREECM_PKG_CONFIG_MODULES)

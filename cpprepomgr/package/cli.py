# Usage:
#   PYTHONPATH=/path/to/RepoConfigsMgr python3 -m cpprepomgr.package.cli --help
#   PYTHONPATH=/path/to/RepoConfigsMgr python3 -m cpprepomgr.package.cli validate-config --config <package.json> --platform mac|win|linux
#   package-tool --help

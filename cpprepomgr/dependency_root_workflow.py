#!/usr/bin/env python3
# Usage:
#   python3 /path/to/RepoConfigsMgr/cpprepomgr/dependency_root_workflow.py --init
#   python3 /path/to/RepoConfigsMgr/cpprepomgr/dependency_root_workflow.py --update
#   PYTHONPATH=/path/to/RepoConfigsMgr python3 -m cpprepomgr.dependency_root_workflow --help

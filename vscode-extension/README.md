# RepoConfigsMgr VS Code Extension

Run RepoConfigsMgr source-root workflow commands from the VS Code status bar.
...
The buttons run these commands in an integrated terminal named `RepoConfigsMgr`.
...
buttons when the workspace provides `configs/repoconfigsmgr.commands.jsonc`.
